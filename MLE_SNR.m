...
Num_Re = 3;% Number of receivers
p_tar = [4000,5000;-800000,-1000000].';
% v_tar = [4,5].';
v_tar = [20,30;4,5].';
...
M = 1.2; % number of durations of sampling
...
% save('data\Value_estimate0dB_1kHz_MT.mat','Value_estimate')
